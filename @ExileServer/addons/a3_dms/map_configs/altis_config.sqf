...
DMS_StaticMissionTypes append [["saltflats",1],["slums",1],["a_village",1],["ai_island",1],["bomos",1],["castle_183",1],["chelonisi",1],["kastro_castle",1],["kore_factory",1],["mayor",1],["military_junkyard",1],["storage_invasion",1]];

// Add the "salt flats base" and "slums" to the "bases" to spawn on server startup. NOTE: "append" and "pushback" are NOT the same.
DMS_BasesToImportOnServerStart append ["saltflatsbase","slums_objects","a_village_buildings","ai_island_buildings","ai_island_bridge","ai_island_buildings","bomos_buildings","castle_183_buildings","chelonisi_buildings","kastro_castle_buildings","kore_factory_buildings","mayor_buildings","military_junkyard_buildings","storage_invasion_buildings"];
