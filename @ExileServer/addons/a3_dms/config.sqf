...
/* Mission System Settings */
	...
	DMS_MaxStaticMissions				= 10;						// Maximum number of Static Missions running at the same time. It's recommended you set this to the same amount of static missions that you have in total. This config will be ignored by "DMS_StaticMissionsOnServerStart".
	...
	DMS_BanditMissionTypes =			[			//	List of missions with spawn chances. If they add up to 100%, they represent the percentage chance each one will spawn
											...
											["paul_fisher",2],
                                            ["paul_safe_mission",5],
                                            ["paul_industrial_new",2],
                                            ["paul_bandits",2],
                                            ["paul_medical",2],
                                            ["paul_dome_mission",2],
                                            ["paul_military_camp",2],
                                            ["paul_cargo_tower",2],
                                            ["paul_beer_transport",2],
                                            ["paul_strider_mission",5],
                                            ["paul_church_mission",2],
                                            ["paul_water_mission",9],
                                            ["paul_littlebird_mission",2],
                                            ["paul_boat_mission",6],
                                            ["paul_clean_energy",2],
                                            ["paul_ah1z",2],
                                            ["paul_jackal",2],
                                            ["paul_hmmwv",2],
                                            ["paul_sandbags_mission",2],
                                            ["paul_highend_mission",2],
                                            ["paul_weed_mission",5],
                                            ["paul_castle",0],
                                            ["paul_apc",2],
